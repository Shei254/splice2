...
class FaqController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('landingpage::landingpage.faqs.index', compact('settings','faqs'));
    ...
    public function faq_create(){
        $settings = LandingPageSetting::settings();
        return view('landingpage::landingpage.faqs.create');
    }
    ...
    public function faq_edit($key){
        ...
        $faqs = json_decode($settings['faqs'], true);
        $faq = $faqs[$key];
        return view('landingpage::landingpage.faqs.edit', compact('faq','key'));
    }
