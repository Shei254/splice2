        ...
        <section class="main-banner bg-primary" id="home">
            <div class="container-offset">
                <div class="row gy-3 g-0 align-items-center">
                    ...
                    <div class="col-xxl-8 col-md-6">
                         <div class="{{ !empty($settings['home_banner']) ? 'dash-preview' : '' }}">
            ...
            <div class="container">
                <div class="row g-0 gy-2 mt-4 align-items-center">
                    <div class="col-xxl-3">
                        <p class="mb-0">@if($settings['home_trusted_by']) {{ __('Trusted by') }} @endif <b class="fw-bold">{{ $settings['home_trusted_by'] }}</b></p>
                    </div>
                    <div class="col-xxl-9">
    ...
    <section class="bg-dark section-gap">
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                <a href="{{ $settings['discover_live_demo_link'] }}" class="btn btn-outline-light rounded-pill">
                     {{ __('Live Demo') }}<i data-feather="play-circle" class="ms-2"></i> </a>
                @endif
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        ...
                        class="card price-card shadow-none {{ $key == 2 ? 'bg-dark' : '' }}">
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price">{{ isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $value->price }}<small
                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1">{{ $value->max_agent < 0 ? __('Unlimited') : $value->max_agent }}
                                                 {{__('Agent')}}</label>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1">{{ $value->enable_custdomain == 'on' ? 'Enable' : 'Disable' }}
                                                 {{__('Custom Domain')}} </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1">{{ $value->enable_custsubdomain == 'on' ? 'Enable' : 'Disable' }}
                                                {{__('Sub Domain')}}</label>
                                        </div>
                                    </li>
                                ...
                                <div class="d-grid">
                                    <a href="{{ route('register') }}" class="btn btn-primary rounded-pill"> {{ __('Start with
    ...
    <footer class="site-footer bg-gray-100">
            ...
            <div class="footer-row">
                ...
                <div class="ftr-col">
                    <ul class="list-unstyled">
                        ...
                        is_object(json_decode($settings['menubar_page'])))
                        @foreach (json_decode($settings['menubar_page']) as $key => $value)
                        @if ($value->page_url != null && $value->footer == 'on')
                        ...
                        @endif
                        @if ($value->footer == 'on' && $value->page_url == null)
                        <li class="nav-item">
                             <a class="nav-link"
                                                    href="{{ route('custom.page', $value->page_slug) }}">{{ $value->menubar_page_name }}</a>
                        </li>
                ...
                <div class="ftr-col ftr-subscribe">
                    ...
                    <form method="post" action="{{ route('join_us_store') }}">
                        ...
                        <div class="input-wrapper border border-dark">
                            ...
                            {{-- <input class="btn btn-dark rounded-pill" type="submit" value="{{ __('Join Us!') }}"> --}}
                            {{-- <button class="btn btn-dark rounded-pill">{{ __('Join Us!') }}</button> --}}
                        </div>
                    </form>
                </div>
                @endif
        ...
        <div class="border-top border-dark text-center p-2">
            ...
            <p class="mb-0"> &copy; {{ date('Y') }}
                {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'TicketGo Saas') }}
                </p>
