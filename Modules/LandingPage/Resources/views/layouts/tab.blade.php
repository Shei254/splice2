...
<a href="{{ route('faqs.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'faqs.index') ? ' active' : '' }}">{{ __('FAQ') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
