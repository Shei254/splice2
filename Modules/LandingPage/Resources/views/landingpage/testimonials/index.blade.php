                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('testimonials_long_description', $settings['testimonials_long_description'], ['class' => 'form-control summernote-simple', 'placeholder' => __('Enter Long Description')]) }}
