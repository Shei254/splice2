...
Route::get('faqs/create/', 'FaqController@faq_create')->name('faq_create');
Route::post('faqs/store/', 'FaqController@faq_store')->name('faq_store');
Route::get('faqs/edit/{key}', 'FaqController@faq_edit')->name('faq_edit');
Route::post('faqs/update/{key}', 'FaqController@faq_update')->name('faq_update');
Route::get('faqs/delete/{key}', 'FaqController@faq_delete')->name('faq_delete');
