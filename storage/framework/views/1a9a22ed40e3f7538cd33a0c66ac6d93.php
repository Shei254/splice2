<?php
    ...
    $sett = App\Models\Utility::settings();
    ...
    $cust_darklayout = $sett['cust_darklayout'];
        ...
        <section class="main-banner bg-primary" id="home">
            <div class="container-offset">
                <div class="row gy-3 g-0 align-items-center">
                    ...
                    <div class="col-xxl-8 col-md-6">
                         <div class="<?php echo e(!empty($settings['home_banner']) ? 'dash-preview' : ''); ?>">
            ...
            <div class="container">
                <div class="row g-0 gy-2 mt-4 align-items-center">
                    <div class="col-xxl-3">
                        <p class="mb-0"><?php if($settings['home_trusted_by']): ?> <?php echo e(__('Trusted by')); ?> <?php endif; ?> <b class="fw-bold"><?php echo e($settings['home_trusted_by']); ?></b></p>
                    </div>
                    <div class="col-xxl-9">
    ...
    <section class="bg-dark section-gap">
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                <a href="<?php echo e($settings['discover_live_demo_link']); ?>" class="btn btn-outline-light rounded-pill">
                     <?php echo e(__('Live Demo')); ?><i data-feather="play-circle" class="ms-2"></i> </a>
                <?php endif; ?>
        ...
        <section class="subscription bg-primary section-gap" id="plan">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <?php
                    // $collection = \App\Models\Plan::take(100)->orderBy('price', 'ASC')->get();
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        ...
                        class="card price-card shadow-none <?php echo e($key == 2 ? 'bg-dark' : ''); ?>">
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price"><?php echo e(isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$'); ?><?php echo e($value->price); ?><small
                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->max_agent < 0 ? __('Unlimited') : $value->max_agent); ?>

                                                 <?php echo e(__('Agent')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->storage_limit); ?>
                                                 ...
                                                 <?php echo e(__('MB Storage Limit')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->enable_custdomain == 'on' ? 'Enable' : 'Disable'); ?>

                                                 <?php echo e(__('Custom Domain')); ?> </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->enable_custsubdomain == 'on' ? 'Enable' : 'Disable'); ?>

                                                <?php echo e(__('Sub Domain')); ?></label>
                                        </div>
                                    </li>
    ...
    <footer class="site-footer bg-gray-100">
            ...
            <div class="footer-row">
                ...
                <div class="ftr-col">
                    <ul class="list-unstyled">
                        ...
                        is_object(json_decode($settings['menubar_page']))): ?>
                        <?php $__currentLoopData = json_decode($settings['menubar_page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($value->page_url != null && $value->footer == 'on'): ?>
                        ...
                        <?php endif; ?>
                        <?php if($value->footer == 'on' && $value->page_url == null): ?>
                        <li class="nav-item">
                             <a class="nav-link"
                                                    href="<?php echo e(route('custom.page', $value->page_slug)); ?>"><?php echo e($value->menubar_page_name); ?></a>
                        </li>
        ...
        <div class="border-top border-dark text-center p-2">
            ...
            <p class="mb-0"> &copy; <?php echo e(date('Y')); ?>
                ...
                <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'TicketGo Saas')); ?>
...
<?php /**PATH /home/splibrjd/public_html/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>