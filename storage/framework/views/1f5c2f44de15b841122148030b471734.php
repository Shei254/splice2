                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('feature_create')); ?>" data-ajax-popup="true"
                                        ...
                                        data-title="<?php echo e(__('Create Features')); ?>" class="btn btn-sm btn-primary">
                                            ...
                                            <label for="highlight_feature_image">
                                                <div class=" bg-primary dark_logo_update">
                                                    ...
                                                    <input style="margin-top: -40px;" type="file"
                                                        class="form-control file" name="highlight_feature_image"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('features_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"
                                        data-title="<?php echo e(__('Create Features Block')); ?>" class="btn btn-sm btn-primary">
                                        <i class="ti ti-plus text-light"></i>
                                    </a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/splibrjd/public_html/Modules/LandingPage/Resources/views/landingpage/features/index.blade.php ENDPATH**/ ?>