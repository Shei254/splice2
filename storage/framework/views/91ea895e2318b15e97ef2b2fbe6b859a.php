        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                        ...
                        <div class="table-responsive">
                            <table class="table pc-dt-simple" id="transaction">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><?php echo e(__('Referral Admin Name')); ?></th>
                ...
                <div id="settings" class="card tab-content d-none">
                    <?php echo e(Form::open(['route' => 'referral-programs.store', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="form-check form-switch custom-switch-v1"mt-1 onclick="enablecookie()">
                                ...
                                <input type="checkbox" class="form-check-input"
                                    name="is_enable" id="is_enable"
                                    <?php echo e(isset($setting) && $setting->is_enable  == '1' ? 'checked="checked"' : ''); ?>>
                            </div>
                        </div>
                    </div>
                    <div class="card-body cookieDiv <?php echo e(isset($setting) && $setting->is_enable  == '0' ? 'disabledCookie ' : ''); ?>">
                        <div class="row">
                            <div class="row ">
                                <div class="col-md-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/splibrjd/public_html/resources/views/referral-program/index.blade.php ENDPATH**/ ?>