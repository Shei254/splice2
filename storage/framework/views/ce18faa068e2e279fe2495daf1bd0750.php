                                                ...
                                                <label for="site_logo">
                                                    <div class="bg-primary m-auto">
                                                        ...
                                                        <input style="margin-top: -40px;" type="file"
                                                            class="form-control file" name="site_logo" id="site_logo"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-url="<?php echo e(route('custom_page.create')); ?>" data-ajax-popup="true"
                                            ...
                                            data-title="<?php echo e(__('Create Custom Page')); ?>" class="btn btn-sm btn-primary">
                                                            ...
                                                            <span>
                                                                <div class="action-btn bg-primary ms-2">
                                                                    <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                                        ...
                                                                        data-title="<?php echo e(__('Edit  Custom Page')); ?>" data-size="lg"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/splibrjd/public_html/Modules/LandingPage/Resources/views/landingpage/menubar/index.blade.php ENDPATH**/ ?>