...
<a href="<?php echo e(route('faqs.index')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e((Request::route()->getName() == 'faqs.index') ? ' active' : ''); ?>"><?php echo e(__('FAQ')); ?> <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
...
<?php /**PATH /home/splibrjd/public_html/Modules/LandingPage/Resources/views/layouts/tab.blade.php ENDPATH**/ ?>