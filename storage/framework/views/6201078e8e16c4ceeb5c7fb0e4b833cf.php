                                            ...
                                            <label for="home_banner">
                                                <div class=" bg-primary dark_logo_update">
                                                    ...
                                                    <input style="margin-top: -40px;" type="file"
                                                        class="form-control file" name="home_banner" id="home_banner"
                                                        data-filename="home_banner" />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/splibrjd/public_html/Modules/LandingPage/Resources/views/landingpage/homesection.blade.php ENDPATH**/ ?>