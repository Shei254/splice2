                        ...
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                @if ($setting['Knowlwdge_Base'] == 'on')
                                    <a class="nav-link" href="{{ route('{slug}/knowledges',$slug) }}">{{ __('Knowledge') }}</a>
                                @endif
                            </li>
                            <li class="nav-item">
                ...
                <div class="col-xl-12 text-center">
                    ...
                    <div class="card">
                        <div class="card-body w-100">
                            ...
                            <form method="post" action="{{route('home.store')}}" class="create-form" enctype="multipart/form-data" id="form_data">
                                @csrf
