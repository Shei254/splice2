                ...
                <div class="container-fluid pe-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('{slug}/tickets',$slug) }}">{{ __('Create Ticket') }}</a>
                            </li>
                            <li class="nav-item">
                                @if ($setting['FAQ'] == 'on')
                                    <a class="nav-link" href="{{route('{slug}/faqs',$slug)}}">{{ __('FAQ') }}</a>
                                @endif
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('{slug}/searches',$slug) }}">{{ __('Search Ticket') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <div class="card" style="min-height: 200px;">
                                            ...
                                            aria-expanded="{{ $index == 0 ? 'true' : 'false' }}">
                                                <div class="row m-auto">
                                                    <h6 class="mr-3">{{ App\Models\Knowledge::knowlege_details($knowledge->title)}}  ( {{ App\Models\Knowledge::category_count($knowledge->category)}} ) </h6>
                                                </div>
                                            </div>
