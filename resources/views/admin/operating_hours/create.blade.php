<form action="{{route('operating_hours.store')}}" method="post">
    @csrf
                        ...
                        @foreach ($days as $key => $day)
                            <div class="row align-items-center gy-4">
                                ...
                                <div class="col-xs-6 col-sm-2"
                                    ...
                                    padding: 7px;
                                    width: 110px;">
                                    <select class="form-control  select2"  name="content[{{ $day }}][start_hour]" id="content2"
                                        placeholder="08">
                                        <option value=""></option>
                                ...
                                <div class="col-xs-6 col-sm-2"
                                    ...
                                    padding: 7px;
                                    width: 110px;">
                                    <select class="form-control  select2"  name="content[{{$day}}][end_hour]" id="content4"
                                        placeholder="17">
                                        <option value=""></option>
